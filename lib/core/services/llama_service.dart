...
class LlamaService {
  ...
  Future<bool> loadModel(String modelPath) async {
    ...
    try {
      ...
      try {
        ...
        log('🔵 [LlamaService] LlamaController created, calling loadModel...');
        ...
        log('🔵 [LlamaService] loadModel completed');
      } catch (e, stackTrace) {
        log('🔴 [LlamaService] Failed to create controller or load model: $e');
        log('🔴 [LlamaService] StackTrace: $stackTrace');
        _controller?.dispose();
        _controller = null;
        _isLoaded = false;
        _loadedModelPath = null;
  ...
  Future<String> generateResponse(String prompt) async {
    if (!_isLoaded || _controller == null) {
      ...
      return '[LlamaService] Not loaded!. Please restart the app.';
    }
    ...
    try {
      ...
      log('🔴 [LlamaService] Generate stackTrace: $stackTrace');
      _isLoaded = false;
